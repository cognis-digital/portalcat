"""Native cognis-connect emit for portalcat — forward findings to any platform.

Maps portalcat's JSON output to the canonical `Finding` and forwards it via
...
Usage:
    portalcat ... --format json | portalcat-emit --to stix
    portalcat-emit --to slack --url $WEBHOOK --dry-run < findings.json
"""
